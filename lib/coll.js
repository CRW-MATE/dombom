...
const xfx = () => {
  if (!PlayerBase[interZept].timeRatekoff) {
    ...
    } else if (PlayerBase[interZept].state == "sprinting" || "sprintingM") {
      PlayerBase[interZept].state = "";
  ...
  constructor() {
    ...
    this.animations = {
      SLM: {
        ...
        do: function () {
          doanim(PlayerBase[interZept], this.arr, 1, 10, this.timeDef, false);
        },
      },
      SL: {
        timeDef: 4,
        ...
        default:
          if (dY && (A.h + A.y - dY <= this.y || A.y - dY >= this.y + this.h)) {
            ...
            if (dX || A.h + A.y - dY > this.y) {
              A.x -= dX;
              A.velX = 0;
              if (PlayerBase[interZept].state == "sprinting" || "sprintingM") {
