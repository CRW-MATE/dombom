...
const movemento = (obj) => {
  ...
  if (obj.state == "crouching") {
    obj.look == "R"
      ? PlayerBase[interZept].characters.CTR.do()
      : PlayerBase[interZept].characters.CTL.do();
    obj.velX = 0;
    obj.velY = 0;
    return;
    ...
    if (
      ...
      obj.look == "R"
        ? PlayerBase[interZept].characters.CWR.do()
        : PlayerBase[interZept].characters.CWL.do();
    } else {
      obj.look == "R"
        ? PlayerBase[interZept].characters.CNR.do()
        : PlayerBase[interZept].characters.CNL.do();
    }
    return;
    ...
    obj.velX *= 0.9;
    obj.look == "R"
      ? PlayerBase[interZept].characters.GTJR.do()
      : PlayerBase[interZept].characters.GTJL.do();
  } else if (obj.state == "jumping" && obj.G) {
    obj.look == "R"
      ? PlayerBase[interZept].characters.JR.do()
      : PlayerBase[interZept].characters.JL.do();
    if (obj.dire == "R") {
      obj.velX = 3;
    } else if (obj.dire == "L") {
      obj.velX = -3;
    ...
    if (
      ...
      PlayerBase[interZept].characters.WR.do();
      ...
      obj.look = "L";
      PlayerBase[interZept].characters.WL.do();
      ...
      if (!PlayerBase[interZept].G) {
        obj.velY = 7;
        obj.look = "U";
        PlayerBase[interZept].characters.WU.do();
      }
      obj.velX = 0;
    } else if (obj.dire === "D") {
      if (!PlayerBase[interZept].G) {
        obj.velY = -7;
        obj.look = "D";
        PlayerBase[interZept].characters.WD.do();
      }
      obj.velX = 0;
    } else if (
      obj.dire === "DL" ||
      ...
      if (PlayerBase[interZept].look == "R") {
        PlayerBase[interZept].characters.NR.do();
      } else if (PlayerBase[interZept].look == "L") {
        PlayerBase[interZept].characters.NL.do();
      } else if (PlayerBase[interZept].look == "D") {
        PlayerBase[interZept].characters.ND.do();
      } else if (PlayerBase[interZept].look == "U") {
        PlayerBase[interZept].characters.NU.do();
      }
      if (!PlayerBase[interZept].G) {
        obj.velY = 0;
      }
